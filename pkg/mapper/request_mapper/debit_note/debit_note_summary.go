...
func MapDebitNoteRequestSummary(summary *structs.DebitNoteSummaryRequest) (*debit_note_models.DebitNoteSummary, error) {
	...
	return &debit_note_models.DebitNoteSummary{
		Summary:         baseSummary,
