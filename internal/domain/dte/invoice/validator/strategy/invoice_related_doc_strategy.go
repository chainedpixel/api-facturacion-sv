...
// Validate - Validates the related documents of a Tax Credit Voucher
...
// validateRelatedDocType - Validates that the related document type is valid for a Tax Credit Voucher
